...
if (isset($_POST['bookticket'])) {
    ...
    if (isset($_POST['ticketid']) && isset($_POST['name']) && isset($_POST['no_of_passenger']) && isset($_POST['departure_location']) && isset($_POST['destination']) && isset($_POST['train_name']) && isset($_POST['  booking_date'])) 
    {
    $ticketid = $_POST['ticketid'];
    $name = $_POST['name'];
    $no_of_pessenger = $_POST['no_of_passenger'];
